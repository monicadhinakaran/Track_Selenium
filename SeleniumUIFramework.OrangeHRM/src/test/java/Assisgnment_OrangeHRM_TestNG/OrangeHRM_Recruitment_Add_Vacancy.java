...
public class OrangeHRM_Recruitment_Add_Vacancy extends BaseClass_Recruitment_Vacancy{
	//WebDriver driver ;
...
//	}
	...
	public void AddVacancy() throws InterruptedException {
		...
		WebElement JobTitle = driver.findElement(By.xpath("//label[. = 'Job Title']/../..//div[@class = 'oxd-select-text--after']"));
		JobTitle.click();
//		action.moveToElement(JobTitle).click();
		...
		action.moveToElement(Hiring_Manager).click().sendKeys("A").pause(Duration.ofSeconds(20)).keyDown(Keys.DOWN).sendKeys(Keys.ENTER).perform();
